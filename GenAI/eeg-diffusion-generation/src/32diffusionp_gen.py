...
for m in (23,):
    with gzip.open("../band_data/s{:02}.pkl.gz".format(m), "rb") as f:
        data = pickle.load(f)
    ...
    for i in range(0, 32):
        ...
        #     filepath="./s14_class32_cp/checkpoint{:02}.ckpt".format(i),
        ...
        checkpoint_path = "./s{:02}_class32_cp/checkpoint{:02}.ckpt".format(m,i)
        ...
        generated_32.append(generated_images)
    
    
    generated_32 = np.array(generated_32)
    
    with open("./generated_data32/s{:02}gen_32_100.pickle".format(m), "wb") as f:
        pickle.dump(generated_32, f)
