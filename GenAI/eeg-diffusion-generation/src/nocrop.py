...
f, t, efdms = stft(data, fs=srate, window='hann', nperseg=128, noverlap=64, nfft = 768)
...
for i in range(4, 32):
    ...
    model_checkpoint_callback = callbacks.ModelCheckpoint(
        filepath="./notcropped_class32_cp/checkpoint{:02}.ckpt".format(i),
